...
class TestKauppa(unittest.TestCase):
    ...
    def test_maksaessa_1_tuote_pankin_metodia_kutsutaan_oikeilla_parametreilla(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_maksaessa_2_eri_tuotetta_pankin_metodia_kutsutaan_oikeilla_parametreilla(
        self,
    ):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
    ...
    def test_maksaessa_2_samaa_tuotetta_pankin_metodia_kutsutaan_oikeilla_parametreilla(
        self,
    ):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
    ...
    def test_maksaessa_tuote_loppu(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            if tuote_id == 2:
    ...
    def test_aloita_asiointi_nollaa_ostoskorin(self):
        # Uusi viite jokaiselle maksutapahtumalle
    ...
    def test_poista_korista(self):
        ...
        self.pankki_mock.tilisiirto.assert_called_with("pekka", ANY, "123456", ANY, 6)
